...
$userId = 1; // Setting user_id to 1 for testing purposes
            ...
            <div class="p-4 md:w-1/3 draggable" draggable="true">
              <div class="h-[640px] border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden">
                ...
                <div class="flex flex-row justify-around mt-4">
                  <a class="button_delete" href="delArticle.php?articleId=<?= $value["id_article"] ?>" class="noselect"><span class="text">Delete</span><span class="icon"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                        <path d="M24 20.188l-8.315-8.209 8.2-8.282-3.697-3.697-8.212 8.318-8.31-8.203-3.666 3.666 8.321 8.24-8.206 8.313 3.666 3.666 8.237-8.318 8.285 8.203z"></path>
                      </svg></span></a>

                  <a href="editArticle.php?articleId=<?= $value["id_article"] ?>" class="Btn">Edit
