    ...
    <div class="space-y-6 flex justify-center items-center  mb-20 bg-transparent">
        <div id="articles-container">
            <div class=" flex justify-center justify-items-center ">
                <div class="w-[600px] h-[300px] top-[300px] duration-500 group overflow-hidden absolute  rounded bg-neutral-800 text-neutral-50 p-4 flex flex-col justify-evenly">
                    ...
                    <div class="absolute blur duration-500 group-hover:blur-none w-24 h-24 bg-sky-700 rounded-full group-hover:-translate-x-12">
                    </div>
                        ...
                        <div class="m-auto  w-[400px] sm:w-[450px] md:w-[600px] sm:w-[550px] ">
                            <div>
                                <button type="button" class="relative w-full flex justify-center items-center px-5 py-2.5 font-medium tracking-wide text-white capitalize   bg-black rounded-md hover:bg-gray-900  focus:outline-none   transition duration-300 transform active:scale-95 ease-in-out">
                                    ...
                                    <input type="file" id="article_picture" name="article_picture[]" accept="image/*" class="border-4 bg-black absolute w-96 mx-12 opacity-0">
                                ...
                                <div class="mt-5 bg-white rounded-lg shadow">
                                    ...
                                    <div class="px-5 pb-5">
                                        ...
                                        <div class="flex">
                                            <div class="flex-grow"><input placeholder="Article title" name="article_title[]" id="article_title" autocomplete="street-address" class=" text-black placeholder-gray-600 w-[180px] sm:w-72 px-4 py-2.5 mt-2 text-base   transition duration-500 ease-in-out transform border-transparent rounded-lg bg-gray-200  focus:border-blueGray-500 focus:bg-white dark:focus:bg-gray-800 focus:outline-none focus:shadow-outline focus:ring-2 ring-offset-current ring-offset-2 ring-gray-400">
                                            </div>
                                        ...
                                        <input placeholder="Paragraph" type="text" name="article_description[]" id="article_description" class=" text-black placeholder-gray-600 w-full h-[150px] px-4 py-2.5 mt-2 text-base   transition duration-500 ease-in-out transform border-transparent rounded-lg bg-gray-200  focus:border-blueGray-500 focus:bg-white dark:focus:bg-gray-800 focus:outline-none focus:shadow-outline focus:ring-2 ring-offset-current ring-offset-2 ring-gray-400">
